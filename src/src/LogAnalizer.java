...
public class LogAnalizer extends JLabel{
	...
	public void on(LogBookEntry msg) {
		if(msg.getType() == LogBookEntry.TYPE.ERROR) {
			System.out.println("LogBookEntry: "+msg.getDate() + " # " + log_name + " # "+ msg.getContext() + " # "+ msg.getText() + " # " + entityIdLabel[msg.getSrcEnt()]);
			cntState[CNT_ERROR]++;
		}
			...
			if(!msg.getText().equals("now in 'CALIBRATION' mode") && !msg.getText().equals("now in 'MANEUVERING' mode")){
				System.out.println("LogBookEntry: "+msg.getDate() + " # " + log_name + " # "+ msg.getContext() + " # "+ msg.getText() + " # " + entityIdLabel[msg.getSrcEnt()]);
